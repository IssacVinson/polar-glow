...
class _CustomerMyBookingsScreenState extends State<CustomerMyBookingsScreen> {
  ...
  Color get _goldColor => AppColors.gold;
    ...
    if (_currentUser == null) {
      return const Scaffold(
        body: GlowEmptyState(
          ...
          message: 'Your bookings will appear here after you sign in.',
        ),
      );
    }
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return const GlowEmptyState(
              ...
              message:
                  'Book a mobile detail from the Book tab. We come to you across Eagle River, Anchorage, Palmer, Wasilla, and JBER.',
            );
          }
